...
print("random bits key generation")
def rand_key(p):
...
print("defining BinarytoDecimal")
...
# Feistel Cipher
PT = "Director of National Intelligence DNI to assess compliance with certain procedures and guidelines issued pursuant to Section 702 of the Foreign Intelligence Surveillance Act of 1978"
